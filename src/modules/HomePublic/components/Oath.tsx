...
export default function Index() {
          ...
          try {
            ...
            appendFormData({
              ...
              addresses: [
                {
                  ...
                  city: {
                    id: cities.find((item) => item.label == applicationForm.generalInformation.personalInformation.permanentAddress.city)?.id,
                    name: applicationForm.generalInformation.personalInformation.permanentAddress.city,
                  },
                ...
                },
                {
                  ...
                  city: {
                    id: cities.find((item) => item.label == applicationForm.generalInformation.personalInformation.presentAddress.city)?.id,
                    name: applicationForm.generalInformation.personalInformation.presentAddress.city,
                  },
              ...
              questionnaires: [
                ...
                {
                  id: 3,
                  Question: "Do you have any medical condition that may prevent you from performing certain types of jobs?",
                  Answer: applicationForm.familyBackground.otherInformation.medicalConditionDetails,
                },
                {
                  id: 4,
                  Question: "Do you have any relatives/family/people in a relationship with you, who are working with us?F",
                  Answer: applicationForm.familyBackground.otherInformation.relativeWorkingWithUsDetails,
                },
              ],
  ...
  return (
    <div className="text-center text-[#6D6D6D] flex flex-col gap-7">
      ...
      <p>
        I certify that all the information I voluntarily provided in the application form is factual and true to the best of my knowledge. I understand that any misrepresentation
        or omission may result in termination of my employment with the company. I also give the company authority to contact schools, employers, references, and others for any
        background check related to my potential employment with Intellismart Technology, Inc., and I hereby release and hold the company harmless from any liability as a result of
        such investigation. Additionally, I acknowledge that I am allowing the company to retain all information and data regarding my employment record for filing purposes.
      </p>
