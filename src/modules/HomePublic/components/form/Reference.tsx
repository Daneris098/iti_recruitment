...
export default function index() {
    ...
    useEffect(() => {
        console.log('applicationForm.educationAndEmployment.employmentRecord : ', applicationForm.educationAndEmployment.employmentRecord[0])
        console.log('activeStepper: ', activeStepper)   
        console.log('applicationForm: ', applicationForm.educationAndEmployment)    
        console.log('is empty ? :', applicationForm.educationAndEmployment.employmentRecord[0] == employmentRecordVal[0])
    }, [activeStepper])
