...
export default function index() {
  ...
  const [cities, setCities] = useState([{ id: 1, value: "MANILA", label: "MANILA" }]);
  ...
  const form = useForm({
    ...
    validate: {
      ...
      personalInformation: {
        ...
        mobileNumber: (value: number | string) =>
          /^\d+$/.test(value.toString()) ? (value.toString().length < 11 ? "Enter a valid mobile number" : null) : "Mobile number must contain digits only",
      ...
      <div className="text-[#6D6D6D] flex flex-col gap-4 relative">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <NumberInput
            ...
            hideControls
            min={1}
            {...form.getInputProps("desiredSalary")}
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            radius="md"
            w={isMobile ? "50%" : "100%"}
            label="Desired Salary"
            placeholder="Desired Salary in PESO"
          />
          <Popover position="bottom" shadow="md" opened={startDateAvailabilityOpened} onChange={setStartDateAvailabilityOpened}>
            <Popover.Target>
              <TextInput
                ...
                classNames={{ input: "poppins text-[#6D6D6D]" }}
                rightSection={<IconCalendarMonth onClick={() => setStartDateAvailabilityOpened((o) => !o)} className="cursor-pointer" />}
                styles={{ label: { color: "#6d6d6d" } }}
                onClick={() => setStartDateAvailabilityOpened((o) => !o)}
              />
            </Popover.Target>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end relative w-full">
          <TextInput
            className="w-full sp:w-1/4"
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            {...form.getInputProps("personalInformation.fullname.lastName")}
            radius="md"
            label={
              <p>
                Full Name <span className="text-red-500">*</span>
                <span className="text-[#A8A8A8] text-xs">(Leave blank if not applicable)</span>
              </p>
            }
          ...
          <TextInput
            className="w-full sp:w-1/4"
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            {...form.getInputProps("personalInformation.fullname.firstName")}
            radius="md"
          ...
          <TextInput
            className="w-full sp:w-1/4"
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            {...form.getInputProps("personalInformation.fullname.middleName")}
            radius="md"
          ...
          <TextInput
            className="w-full sp:w-1/4"
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            {...form.getInputProps("personalInformation.fullname.suffix")}
            radius="md"
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end relative w-full">
          <div className="w-full sp:w-1/2 flex items-end gap-4">
            <TextInput
              className="w-full sp:w-1/2"
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.presentAddress.unitNo")}
              key={form.key("personalInformation.presentAddress.unitNo")}
              radius="md"
              label={
                <p>
                  Present Address <span className="text-red-500">*</span>
                  <span className="text-[#A8A8A8] absolute text-xs">(Leave blank if not applicable)</span>
                </p>
              }
              placeholder="Unit no."
            />
            <TextInput
              className="w-full sp:w-1/2"
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.presentAddress.houseNo")}
              key={form.key("personalInformation.presentAddress.houseNo")}
              radius="md"
          ...
          <div className="w-full sp:w-1/2 flex flex-col sp:flex-row items-end gap-4">
            <TextInput
              className="w-full sp:w-1/2"
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.presentAddress.street")}
              key={form.key("personalInformation.presentAddress.street")}
              radius="md"
              placeholder="Street"
            />
            <TextInput
              className="w-full sp:w-1/2"
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.presentAddress.subdivision")}
              key={form.key("personalInformation.presentAddress.subdivision")}
              radius="md"
          ...
          <div className={cn("w-[100%]", isMobile && "w-[25%]  ")}>
            ...
            {!sameAsPresent ? (
              <TextInput
                ...
                withAsterisk
                classNames={{ input: "poppins text-[#6D6D6D]" }}
                {...form.getInputProps("personalInformation.permanentAddress.unitNo")}
                key={form.key("personalInformation.permanentAddress.unitNo")}
                radius="md"
                w={isMobile ? "25%" : "100%"}
          ...
          {!sameAsPresent && (
            <>
              <TextInput
                disabled={sameAsPresent}
                classNames={{ input: "poppins text-[#6D6D6D]" }}
                {...form.getInputProps("personalInformation.permanentAddress.houseNo")}
                key={form.key("personalInformation.permanentAddress.houseNo")}
                radius="md"
                w={isMobile ? "25%" : "100%"}
                placeholder="House no."
              />
              <TextInput
                disabled={sameAsPresent}
                classNames={{ input: "poppins text-[#6D6D6D]" }}
                {...form.getInputProps("personalInformation.permanentAddress.street")}
                key={form.key("personalInformation.permanentAddress.street")}
                radius="md"
                w={isMobile ? "25%" : "100%"}
                placeholder="Street"
              />
              <TextInput
                disabled={sameAsPresent}
                classNames={{ input: "poppins text-[#6D6D6D]" }}
                {...form.getInputProps("personalInformation.permanentAddress.subdivision")}
                key={form.key("personalInformation.permanentAddress.subdivision")}
                radius="md"
                w={isMobile ? "25%" : "100%"}
                placeholder="Subdivision"
              />
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end">
          <div className="flex flex-col sp:flex-row gap-4 items-end w-full sp:w-1/2">
            <Popover position="bottom" shadow="md" trapFocus={true} returnFocus={false} opened={datedOfBirthOpened} onChange={setDatedOfBirthOpenedOpened}>
              <Popover.Target>
                <TextInput
                  withAsterisk
            ...
            <TextInput
              withAsterisk
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.placeOfBirth")}
              radius="md"
              w={isMobile ? "25%" : "100%"}
          ...
          <div className="flex flex-row gap-4 items-end w-full sp:w-1/2">
            <TextInput
              disabled
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              key={form.key("personalInformation.age")}
              {...form.getInputProps("personalInformation.age")}
              radius="md"
              w={isMobile ? "25%" : "100%"}
              label="Age"
              placeholder="Age"
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end">
          <div className="flex flex-row gap-4  w-full sp:w-1/2">
            <NumberInput
              hideControls
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.height")}
              radius="md"
              w={isMobile ? "25%" : "100%"}
              label="Height"
              placeholder="Height"
            ...
            <NumberInput
              hideControls
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.weight")}
              radius="md"
              w={isMobile ? "25%" : "100%"}
              label="Weight"
              placeholder="Weight"
          ...
          <div className="flex flex-row gap-4  w-full sp:w-1/2">
            <Select
              ...
              withAsterisk
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.civilStatus")}
              radius="md"
              w={isMobile ? "25%" : "100%"}
              label="Civil Status"
            ...
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.religion")}
              radius="md"
              w={isMobile ? "25%" : "100%"}
              label="Religion"
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end">
          <TextInput
            ...
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            withAsterisk
            {...form.getInputProps("personalInformation.mobileNumber")}
            radius="md"
            w={isMobile ? "33%" : "100%"}
            label="Mobile Number"
          ...
          <TextInput
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            withAsterisk
            {...form.getInputProps("personalInformation.workingEmailAddress")}
            radius="md"
            w={isMobile ? "33%" : "100%"}
          ...
          <TextInput
            maxLength={8}
            classNames={{ input: "poppins text-[#6D6D6D]" }}
            {...form.getInputProps("personalInformation.landlineNumber")}
            radius="md"
            w={isMobile ? "33%" : "100%"}
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end">
          <div className="flex flex-row gap-4 items-end w-full sp:w-1/2">
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.sssNo")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
              label="Government ID Number(s)"
              placeholder="SSS No."
            />
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.gsisNo")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
              placeholder="GSIS No."
            />
          ...
          <div className="flex flex-row gap-4 items-end w-full sp:w-1/2">
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.pagibigNo")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
            ...
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.philhealthNo")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-end">
          <div className="flex flex-row gap-4 items-end w-full sp:w-1/2">
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.driversLicense")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
            ...
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.passport")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
          ...
          <div className="flex flex-row gap-4 items-end w-full sp:w-1/2">
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.tinNo")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
              placeholder="TIN No."
            />
            <TextInput
              classNames={{ input: "poppins text-[#6D6D6D]" }}
              {...form.getInputProps("personalInformation.governmentIdOrNumber.rdoCode")}
              radius="md"
              w={isMobile ? "33%" : "100%"}
