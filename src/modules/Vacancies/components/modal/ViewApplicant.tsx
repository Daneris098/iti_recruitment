...
export default function index() {
  ...
  return (
    <>
      <Modal
        size={"80%"}
        opened={selectedData != selectedDataVal}
        centered
        onClose={() => setSelectedData(selectedDataVal)}
          ...
          <div className=" h-[98%] ">
            <DataTable
              ...
              columns={[
                {
                  accessor: "applied",
                  render: (data: any) => <>{data.applied.name}</>,
                  title: (
                  ...
                  textAlign: "left",
                  sortable: true,
                  titleStyle: (theme) => ({ color: theme.colors.blue[3], background: "rgb(222, 236, 255, 0.3)", fontWeight: "normal" }),
                },
                {
                  accessor: "forInterview",
                  render: (data: any) => <>{data.forInterview.name}</>,
                  title: (
                  ...
                  textAlign: "left",
                  sortable: true,
                  titleStyle: (theme) => ({ color: theme.colors.orange[6], background: "rgb(255,216,182, 0.3)", fontWeight: "normal" }),
                },
                {
                  accessor: "offered",
                  render: (data: any) => <>{data.offered.name}</>,
                  title: (
                    <div className="flex gap-2 p-[0.5rem] rounded-[0.3rem]">
                      <p>Offered</p>
                  ...
                  textAlign: "left",
                  sortable: true,
                  titleStyle: (theme) => ({ color: theme.colors.yellow[6], background: "rgb(255,240,192,0.3)", fontWeight: "normal" }),
                },
                {
                  accessor: "hired",
                  render: (data: any) => <>{data.hired.name}</>,
                  title: (
                    <div className="flex gap-2 p-[0.5rem] rounded-[0.3rem]">
                      <p>Hired</p>
                  ...
                  textAlign: "left",
                  sortable: true,
                  titleStyle: (theme) => ({ color: theme.colors.green[6], background: "rgb(215,255,185, 0.3)", fontWeight: "normal" }),
                },
                {
                  accessor: "archived",
                  render: (data: any) => <>{data.archived.name}</>,
                  title: (
                    <div className="flex gap-2 p-[0.5rem] rounded-[0.3rem]">
                      <p>Archived</p>
