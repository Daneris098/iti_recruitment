import ViewApplicant from '@modules/Vacancies/components/documents/main/ViewApplicant'
...
export default function index() {
    const { setIsViewApplicant, isViewApplicant, selectedApplicant } = ApplicantStore()
    const Applicant_Name = selectedApplicant.Applicant_Name,
    ...
    return (
        <>
            <Modal size={'65%'} withCloseButton={false} opened={isViewApplicant} centered onClose={() => setIsViewApplicant(false)}
                styles={{
                    // body: { minHeight: '50rem' },
                    ...
                    <div className='h-[6%]'>
                        <div className="flex justify-between items-center">
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <IconX stroke={1} onClick={() => { setIsViewApplicant(false) }}
