      ...
      <div className="m-auto w-[95%] ">
        ...
        <form ref={formRef} onSubmit={form.onSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-8 mt-4">
            <div className="flex gap-4">
              <Checkbox className="w-[50%]" checked={isGenerated} onChange={(event) => setIsGenerated(event.currentTarget.checked)} label="Generate Password" />
            </div>
            <div className="flex justify-between">
              <Button variant="outline" className=" w-[25%] self-end" radius={10} onClick={() => setAction("")}>
                CANCEL
              </Button>
              <Button
                variant="transparent"
