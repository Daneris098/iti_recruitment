    ...
    <>
      <Modal
        ...
        <div className="flex flex-col mt-6 items-center gap-4 text-[#6D6D6D]">
          ...
          <Text className="text-xl font-bold">All Changes have been successfully saved!</Text>
        </div>
      </Modal>
      ...
      <Modal
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <p className="text-2xl text-[#559CDA] font-semibold">Edit Success</p>
            <IconX size={30} className="text-[#6D6D6D]" onClick={() => setAlert("")} />
          </div>
          <Divider size="xs" color="#6D6D6D" />
        </div>
        <div className="flex flex-col mt-6 items-center gap-4 text-[#6D6D6D]">
          <CircleCheckBig color="#559cda" size={70} strokeWidth={1} />
          <Text className="text-xl font-bold text-center">You've successfully edited the account status.</Text>
        </div>
      </Modal>
      ...
      <Modal
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <p className="text-2xl text-[#559CDA] font-semibold">Reset Success</p>
            <IconX size={30} className="text-[#6D6D6D]" onClick={() => setAlert("")} />
          </div>
          <Divider size="xs" color="#6D6D6D" />
        </div>
        <div className="flex flex-col mt-6 items-center gap-4 text-[#6D6D6D]">
          <CircleCheckBig color="#559cda" size={70} strokeWidth={1} />
          <Text className="text-xl font-bold text-center">You've successfully reset the user credentials.</Text>
          <Button
            ...
            onClick={() => {
              setAlert("");
              navigator.clipboard
                .writeText(JSON.stringify(resetCredentials, null, 2))
                .then(() => {
      ...
      <Modal
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <p className="text-2xl text-[#559CDA] font-semibold">Create Account Success</p>
            <IconX size={30} className="text-[#6D6D6D]" onClick={() => setAlert("")} />
          </div>
          <Divider size="xs" color="#6D6D6D" />
        </div>
        <div className="flex flex-col mt-6 items-center gap-4 text-[#6D6D6D]">
          <CircleCheckBig color="#559cda" size={70} strokeWidth={1} />
          <Text className="text-xl font-bold text-center">You've successfully added a new account.</Text>
          <Button
            className="w-[50%] rounded-md"
            variant="outline"
            onClick={() => {
              navigator.clipboard
                .writeText(newlyAddedUser.password)
                .then(() => {
                  console.log("Copied to clipboard!");
                })
                .catch((err) => {
      ...
      <Modal
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <p className="text-2xl text-[#559CDA] font-semibold">Reset Confirmation</p>
            <IconX size={30} className="text-[#6D6D6D]" onClick={() => setAlert("")} />
          </div>
          <Divider size="xs" color="#6D6D6D" />
        </div>
        <div className="flex flex-col mt-6 items-center gap-4 text-[#6D6D6D]">
          ...
          <Text className="text-xl font-bold text-center">Are you sure you want to reset the account credentials?</Text>
          <div className="flex gap-2 w-[80%]">
            <Button
              className="w-[50%] rounded-md"
              variant="outline"
