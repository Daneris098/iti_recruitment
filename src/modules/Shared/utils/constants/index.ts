...
export const BASE_COLUMNS = ['applicantName', 'dateGenerated', 'dateLastUpdated'];
export const BASE_COLUMNS_WITH_STATUS = [...BASE_COLUMNS, 'status', 'attachments'];
export const BASE_COLUMNS_WITH_REMARKS = [...BASE_COLUMNS, 'remarks', 'status'];
