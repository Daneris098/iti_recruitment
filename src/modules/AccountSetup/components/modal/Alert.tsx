    ...
    <>
      <Modal
        ...
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <p className="text-2xl text-[#559CDA] font-semibold">Save Account Information</p>
      ...
      <Modal opened={alert === AlertType.saved} withCloseButton={false} onClose={() => setAlert("")} centered size={modalSize} padding={30}>
        ...
        <div className="flex flex-col mt-6 items-center gap-4 text-[#6D6D6D]">
          ...
          <Text className="text-xl font-semibold text-center">Congratulations! Initial account setup complete!</Text>
        </div>
      </Modal>

      <Modal opened={alert === AlertType.nextStep} withCloseButton={false} onClose={() => setAlert("")} centered size={modalSize} padding={30}>
        <div className="flex flex-col gap-3">
          <div className="flex justify-between">
            <p className="text-2xl text-[#559CDA] font-semibold">Next Step</p>
          </div>
          <Divider size="xs" color="#6D6D6D" />
        </div>
        <div className="flex flex-col mt-6 items-center gap-4 text-[#6D6D6D]">
