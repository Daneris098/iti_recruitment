...
const Hiring = forwardRef((_, ref) => {
    ...
    const form = useForm({
        mode: "uncontrolled",
        initialValues: formValue.hiring,
        validate: {
            offerResponsePeriod: (value: number | null) => value === null ? "Offer Response Period is required" : null,
            applicationSettings: {
                allowReApply: (value: boolean | null) => value === null ? "Required" : null,
                alloweReApplyAfer: (value: number | null) => value === null ? "Required" : null,
            },
            interviewStages: {
                name: (value: string) => value.length === 0 ? "Interviewer name is required" : null,
            },
            interviewers: {
                name: (value: string) => value.length === 0 ? "Interviewer name is required" : null,
            },
    ...
    useEffect(() => {
        form.setValues({
            applicationSettings: accountSetupForm.hiring.applicationSettings,
            interviewers: accountSetupForm.hiring.interviewers,
            interviewStages: accountSetupForm.hiring.interviewStages,
            offerResponsePeriod: accountSetupForm.hiring.offerResponsePeriod,
        });
    }, [accountSetupForm])
