    ...
    return (
      <div className="w-[75%] h-[10%]  mx-auto flex flex-col ">
        <div className="flex self-center sm:self-end gap-4  text-white mb-8">
          <Button
            variant="outline"
            className={cn("self-end w-[150px] rounded-md")}
            onClick={() => {
              if (activeStepper > 0) setActiveStepper(activeStepper - 1);
            }}>
            BACK
          </Button>
          <Button
            variant="outline"
            className={cn("self-end w-[150px] rounded-md br-gradient border-none text-white")}
            onClick={() => {
