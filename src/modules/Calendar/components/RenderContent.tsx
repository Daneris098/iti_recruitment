...
export default function renderEventContent(eventInfo: EventContentArg) {
  ...
  return (
    <Container bg={eventInfo.backgroundColor} className={`flex flex-row overflow-hidden h-4 pl-3 hover:overflow-visible w-full rounded-md truncate cursor-pointer hover:scale-105`}>
