...
export default function renderEventContent(eventInfo: EventContentArg) {
  ...
  return (
    <Container
      ...
      className={`flex flex-row overflow-hidden h-4 pl-3 hover:overflow-visible w-full rounded-md truncate cursor-pointer hover:scale-105`}>
      <Text c={eventInfo.textColor} size="12px" fw={600} py={2}>
        {eventDetails.title}
      </Text>
    </Container>
  );
