...
export default function index() {
    ...
    return (
        <div className="flex flex-col gap-4">
            ...
            <MultiSelect classNames={{ input: 'poppins text-[#6D6D6D]', pill: 'poppins text-[#6D6D6D]', dropdown: 'poppins text-[#6D6D6D]' }} radius={8} data={source} className="w-full text-[#6D6D6D]" size="md" label="Source Type" placeholder="Select Source Type" rightSection={<IconCaretDownFilled size='18' />} />
        </div>
    )
}