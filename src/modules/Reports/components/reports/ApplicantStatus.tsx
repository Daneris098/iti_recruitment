...
export default function index() {
    ...
    return (
        <div className="flex flex-col gap-4">
            <Select radius={8} data={["ITI", 'ALL']} className="w-full text-[#6D6D6D]" size="md" label="Company" placeholder="ALL" rightSection={<IconCaretDownFilled size='18' />} />
            <DateRange
                gapValue={20}
                size="md"
                value={value}
            ...
            <Select radius={8} data={["ITI", 'ALL']} className="w-full text-[#6D6D6D]" size="md" label="Applicant Status" placeholder="ALL" rightSection={<IconCaretDownFilled size='18' />} />
        </div>
    )
}