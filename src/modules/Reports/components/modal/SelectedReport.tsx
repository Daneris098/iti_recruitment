...
import {
  ...
  ApplicationForm,
} from "@modules/Reports/components/reports";
import {
...
} from "@modules/Reports/components/reports/preview/index";
...
export default function index() {
  ...
  } else if (selectedReport?.type === Reports.applicationForm) {
    currentReportComponent = <ApplicationForm />;
    currentReportPreviewComponent = <ApplicationFormPreview />;
  } else {
        ...
        <div className="flex flex-col gap-4 p-4">
          <div className="flex flex-col gap-3">
            <div className="flex justify-between">
              <p className="text-2xl text-[#559CDA] font-semibold">{isPreview ? selectedReport?.name : selectedReport?.title}</p>
              <IconX
                size={30}
          ...
          {isPreview ? (
            <>
              ...
              <Button
                variant="transparent"
                className="br-gradient border-none text-white sm:w-[25%] lg:w-[14%] self-end"
                radius={10}
                onClick={() => {
                  setAlert(AlertType.downloadReportSuccess);
                  setSelectedReport(null);
                }}>
                DOWNLOAD REPORT
              </Button>
            ...
            <>
              ...
              <Button
                variant="transparent"
                className="br-gradient border-none text-white sm:w-[25%] lg:w-[13%] self-end"
                radius={10}
                onClick={() => {
                  setIsPreview(true);
                }}>
